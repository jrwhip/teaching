  ...
  return /******/ (function () {
    ...
    /******/ var __webpack_modules__ = {
      /***/ 282: /***/ function (
        ...
        exports.clearChoices =
          exports.activateChoices =
          exports.filterChoices =
          exports.addChoice =
            void 0;
      ...
      /***/ 373: /***/ function (
        ...
        var Choices = /** @class */ (function () {
          function Choices(element, userConfig) {
            ...
            this.config = deepmerge_1.default.all(
              [defaults_1.DEFAULT_CONFIG, Choices.defaults.options, userConfig],
           ...
           * ```
           */
          Choices.prototype.setChoices = function (
          ...
          Choices.prototype._createGroupsFragment = function (
            groups,
            choices,
            fragment
          ) {
          ...
          Choices.prototype._createChoicesFragment = function (
            choices,
            fragment,
            withinGroup
          ) {
          ...
          Choices.prototype._selectPlaceholderChoice = function (
            placeholderChoice
          ) {
            this._addItem({
          ...
          Choices.prototype._handleButtonAction = function (
            activeItems,
            element
          ) {
            if (
          ...
          Choices.prototype._handleItemAction = function (
            activeItems,
            element,
            hasShiftKey
          ) {
          ...
          Choices.prototype._handleChoiceAction = function (
            activeItems,
            element
          ) {
        ...
        */
          ...
          Choices.prototype._onEnterKey = function (
            event,
            activeItems,
            hasActiveDropdown
          ) {
          ...
          Choices.prototype._onDirectionKey = function (
            event,
            hasActiveDropdown
          ) {
            var keyCode = event.keyCode,
              ...
              if (skipKey) {
                if (directionInt > 0) {
                  nextEl = this.dropdown.element.querySelector(
                    ''.concat(selectableChoiceIdentifier, ':last-of-type')
                  );
                } else {
                  nextEl = this.dropdown.element.querySelector(
          ...
          Choices.prototype._onDeleteKey = function (
            event,
            activeItems,
            hasFocusedInput
          ) {
      ...
      /***/ 613: /***/ function (
        ...
        var Container = /** @class */ (function () {
          ...
          Container.prototype.setActiveDescendant = function (
            activeDescendantID
          ) {
      ...
      /***/ 624: /***/ function (
        ...
        var List = /** @class */ (function () {
          ...
          List.prototype._scrollDown = function (
            scrollPos,
            strength,
            destination
          ) {
          ...
          List.prototype._scrollUp = function (
            scrollPos,
            strength,
            destination
          ) {
      ...
      /***/ 883: /***/ function (__unused_webpack_module, exports) {
        ...
        exports.SCROLLING_SPEED =
          exports.SELECT_MULTIPLE_TYPE =
          exports.SELECT_ONE_TYPE =
          exports.TEXT_TYPE =
          exports.KEY_CODES =
      ...
      /***/ 799: /***/ function (__unused_webpack_module, exports) {
        ...
        exports.parseCustomProperties =
          exports.diff =
          exports.cloneObject =
          exports.existsInArray =
          exports.dispatchEvent =
          exports.sortByScore =
          exports.sortByAlpha =
          exports.strToEl =
          exports.sanitise =
          exports.isScrolledIntoView =
          exports.getAdjacentEl =
          exports.wrap =
          exports.isType =
          exports.getType =
          exports.generateId =
          exports.generateChars =
        ...
        var generateId = function (element, prefix) {
          var id =
            ...
            (element.name &&
              ''
                .concat(element.name, '-')
                .concat((0, exports.generateChars)(2))) ||
        ...
        */
            ...
            case 'FILTER_CHOICES': {
              ...
              return state.map(function (obj) {
                ...
                choice.active = filterChoicesAction_1.results.some(function (
                  _a
                ) {
                  var item = _a.item,
                    score = _a.score;
    ...
    !(function () {
      /* harmony import */ var _scripts_choices__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(373);
      /* harmony import */ var _scripts_choices__WEBPACK_IMPORTED_MODULE_0___default =
        /*#__PURE__*/ __webpack_require__.n(
          _scripts_choices__WEBPACK_IMPORTED_MODULE_0__
        );
      /* harmony import */ var _scripts_interfaces__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(187);
      /* harmony import */ var _scripts_interfaces__WEBPACK_IMPORTED_MODULE_1___default =
        /*#__PURE__*/ __webpack_require__.n(
          _scripts_interfaces__WEBPACK_IMPORTED_MODULE_1__
        );
      /* harmony import */ var _scripts_constants__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(883);
      /* harmony import */ var _scripts_defaults__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(789);
      /* harmony import */ var _scripts_templates__WEBPACK_IMPORTED_MODULE_4__ =
