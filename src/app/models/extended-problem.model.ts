...
const operationLookup: { [key: string]: { [key: string]: OperationLookup } } = {
  Basics: {
    addition: {
...
export class ExtendedProblem extends Problem {
  ...
  constructor(
    ...
    this.videoIds = {
      teaching: operationLookup['Basics'][operation].teachingVideoId,
      example: operationLookup['Basics'][operation].exampleVideoId,
    };
  }
  static operationLookup(operation: string): OperationLookup {
    return operationLookup['Basics'][operation];
  }
}
